...
echo '<TABLE BORDER="1"><TR><TH> UTF-8 </TH><TH> Latinnica </TH><TH> # </TH><TH> Win1251 </TH><TH> Latinnica </TH><TH> # </TH></TR>'; 
 
for($i=0;$i<$cyr_symbols;$i++) 
	{ 
		echo 
"<TR><TD><B>&#".(1040+$i).";</B></TD><TD>{$WIN1251NLAT[$i][0]}</TD><TD>".(1040+$i)."</TD><TD><B>".chr($WIN1251NLAT[$i][3])."</B></TD><TD>{$WIN1251NLAT[$i][2]}</TD><TD>".(($WIN1251NLAT[$i][3]>32)?$WIN1251NLAT[$i][3]:'')."</TD></TR>\n"; 
	} 
 ?> 
